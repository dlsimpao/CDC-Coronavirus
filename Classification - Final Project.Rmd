         ...
         Neg Pred Value : 0.6667          
              Precision : 0.9846          
                 Recall : 0.9985          
                     F1 : 0.9915          
             Prevalence : 0.9817          
         Detection Rate : 0.9802          
   Detection Prevalence : 0.9956          
...
The metric "Accuracy" was not in the result set. ROC will be used instead.rf variable importance
...
#### ERROR Error in eval(predvars, data, env) : object 'age_group.80..Years' not found
         ...
         Neg Pred Value : 0.5882          
              Precision : 0.9893          
                 Recall : 0.9974          
                     F1 : 0.9933          
             Prevalence : 0.9857          
         Detection Rate : 0.9832          
   Detection Prevalence : 0.9938          
         ...
         Neg Pred Value : 0.3750          
              Precision : 0.9878          
                 Recall : 0.9963          
                     F1 : 0.9921          
             Prevalence : 0.9857          
         Detection Rate : 0.9821          
   Detection Prevalence : 0.9941          
...
# Logistic Reg
# Error in eval(predvars, data, env) : object 'age_group.60...69.Years' not found
...
#### SVM 
#ERROR - age_group 60...69 not found
