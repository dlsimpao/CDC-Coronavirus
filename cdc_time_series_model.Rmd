...
```{r}
cdc_xts_may_diff1 = diff(cdc_xts_may, differences = 12)
...
cdc_xts_may_diff1 = diff(cdc_xts_may, lag = 12)
...
cdc_xts_may_lag712 = diff(diff(cdc_xts_may,7),12)
```
```{r}
cdc_xts_may_diff7 = diff(cdc_xts_may_diff1, differences = 7)
plot.xts(cdc_xts_may_diff7, col = "dark green")
```
```{r}
acf2(diff(cdc_xts_may_diff1,7))
```
